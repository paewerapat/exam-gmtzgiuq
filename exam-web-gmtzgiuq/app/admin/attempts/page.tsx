      ...
      <div className="max-w-7xl mx-auto px-4">
        <FadeIn>
          <div className="mb-6">
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">ดูผลการทำข้อสอบของผู้ใช้ทุกคน</p>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400">ทำข้อสอบทั้งหมด</span>
                </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400">ผู้ใช้ที่เข้าสอบ</span>
                </div>
                <div className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                  {stats.uniqueUsers}
                </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400">หมวดหมู่</span>
                </div>
                <div className="text-2xl font-bold text-gray-900 dark:text-gray-100">
