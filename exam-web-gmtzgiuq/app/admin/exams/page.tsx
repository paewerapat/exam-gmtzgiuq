      ...
      <div className="max-w-7xl mx-auto px-4">
        <FadeIn>
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">จัดการชุดข้อสอบ</h1>
          ...
          <div className="flex gap-6">
            ...
            <div className="w-56 flex-shrink-0">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-3">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 px-3 mb-2">หมวดหมู่</h3>
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 mt-3 pt-3">
                  <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 px-3 mb-2">สถานะ</h3>
                  ...
                  <>
                    <table className="w-full">
                      <thead className="bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                        <tr>
                          <th className="text-left px-4 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">ชื่อชุดข้อสอบ</th>
                          <th className="text-left px-4 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">หมวดหมู่</th>
                          <th className="text-left px-4 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">จำนวนข้อ</th>
                          <th className="text-left px-4 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">สถานะ</th>
                          <th className="text-right px-4 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">จัดการ</th>
                        </tr>
                      </thead>
                        ...
                        {data.items.map((exam) => (
                          <tr key={exam.id} className="hover:bg-gray-50">
                            <td className="px-4 py-4">
                              ...
                              {exam.description && (
                                <div className="text-sm text-gray-500 dark:text-gray-400 mt-0.5 line-clamp-1">{exam.description}</div>
                              )}
                            </td>
                            <td className="px-4 py-4">
                            ...
                            <td className="px-4 py-4">
                              <span className="text-sm text-gray-600 dark:text-gray-400">{exam.questionCount} ข้อ</span>
                            </td>
                            <td className="px-4 py-4">
                              <button
                              ...
                              >
                                {toggling === exam.id ? (
                                  ...
                                  <>
                                    ...
                                    <span className="text-green-600 dark:text-green-400">เผยแพร่</span>
                                  </>
                                ) : (
                                  <>
                                    <XCircle className="w-3 h-3 mr-1 text-gray-500 dark:text-gray-400" />
                                    <span className="text-gray-500 dark:text-gray-400">แบบร่าง</span>
                                  </>
                                )}
                              </button>
                            </td>
                            <td className="px-4 py-4">
                              <div className="flex items-center justify-end space-x-1">
                                ...
                                <button
                                  ...
                                  className="p-1.5 text-gray-500 dark:text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition disabled:opacity-50"
                                >
                                  {deleting === exam.id ? (
