        ...
        <FadeIn>
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden">
            {loading ? (
              ...
              <div className="p-8 text-center text-gray-500">ยังไม่มี feedback</div>
            ) : (
              <>
                    ...
                    <li key={fb.id} className="p-4">
                      <div className="flex items-center justify-between gap-3 mb-2">
                        <div className="flex items-center gap-2 text-sm text-gray-700">
                          ...
                          {userLabel(fb.user)}
                          {fb.age != null && (
                            <span className="text-gray-400">· อายุ {fb.age}</span>
                          )}
                        </div>
                      ...
                      {fb.details && (
                        <p className="text-gray-500 text-sm mt-1">{fb.details}</p>
                      )}
                      {fb.examId && (
                        <p className="text-xs text-gray-400 mt-2">เกี่ยวกับข้อสอบ: {fb.examId}</p>
                      )}
                    </li>
                  ))}
                </ul>
