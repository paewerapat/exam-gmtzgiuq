  ...
  return (
    <Link href={`/blogs/${blog.slug}`} className="block">
      <article className="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition overflow-hidden group h-full">
        ...
        <div className="p-6">
          <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2 group-hover:text-amber-600 transition line-clamp-2">
            {blog.title}
          </h3>
      ...
      <div className="bg-gradient-to-br from-amber-600 to-orange-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-amber-100 max-w-2xl">
            เธเธ—เธเธงเธฒเธกเน€เธเธดเธเธฅเธถเธเนเธฅเธฐเธเธฒเธฃเธงเธดเน€เธเธฃเธฒเธฐเธซเน
          </p>
        </div>
      </div>
        ...
        <div className="mb-8">
          <div className="relative max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition"
            />
          </div>
        </div>
            ...
            {data.items.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                <h3 className="text-xl font-semibold text-gray-600 dark:text-gray-400 mb-2">
                  {debouncedSearch ? 'เนเธกเนเธเธเธเธ—เธเธงเธฒเธก' : 'เธขเธฑเธเนเธกเนเธกเธต Essays'}
                </h3>
