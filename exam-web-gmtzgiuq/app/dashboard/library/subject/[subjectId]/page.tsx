...
import { getPublicCurriculumTree, type Subject, type Chapter, type Topic } from '@/lib/api/curriculum';
...
export default function SubjectAllTopicsPage() {
        ...
        <>
          ...
          >
            <h1 className="text-white font-bold text-2xl">
              {subject.iconEmoji && <span className="mr-2">{subject.iconEmoji}</span>}
              {subject.name}
            </h1>
            <p className="text-white/70 text-sm mt-1">
              {subject.examCount ?? 0} ชุดข้อสอบทั้งหมด
            </p>
          </div>
